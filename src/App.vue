  ...
  methods : {
    ...
    async liveSearcher(liveInputSearchValue) {
      ...
      this.pokemons = this.allPokemons.filter(pokemon => {
        ...
        return equivalentSearchedWord.toLowerCase() === liveInputSearchValue.toLowerCase()
      })
     }
    }
  },
